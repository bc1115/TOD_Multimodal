...
```{r, CCA of raw SA/CT with fALFF/RehO, echo = FALSE, include=FALSE}
...
```{r, t-tests struc and func CV, echo = TRUE, include=TRUE}
...
##Linear regression of struc and func CV with age, dx, and age by dx interaction 
```{r, LM of struc and func CV, echo = FALSE, include=TRUE}
...
```{r, LM of struc and funct CV with Mullen ELC, echo = FALSE, include=TRUE}
...
```{r, LM of struc and funct CV with ADOS CSS, echo = FALSE, include=TRUE}
...
```{r, CCA of raw SA with fALFF, echo = FALSE, include=FALSE}
...
```{r, t-tests raw SA with fALFF, echo = TRUE, include=TRUE}
...
##Linear regression of SA and fALFF CV with age, dx, and age by dx interaction 
```{r, LM of SA and fALFF CV, echo = FALSE, include=TRUE}
...
```{r, LM of SA and fALFF CV with Mullen ELC, echo = FALSE, include=TRUE}
...
```{r, LM of SA and fALFF CV with ADOS CSS, echo = FALSE, include=TRUE}
...
##Linear regression of individual ROI SA fALFF with age, dx, and age by dx interaction 
```{r, LM of SA and fALFF ROI, echo = FALSE, include=TRUE}
